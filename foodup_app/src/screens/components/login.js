...
const LoginForm = (props) => {
  ...
  const [activationValidationMessage, setActivationValidationMessage] =
    useState("");
  ...
  const [registerRestaurantTelephone, setRegisterRestaurantTelephone] =
    useState("");
  const [registerRestaurantEmail, setRegisterRestaurantEmail] = useState("");
  const [registerRestaurantWebsite, setRegisterRestaurantWebsite] =
    useState("");
  ...
  const [registerRestaurantFirstName, setRegisterRestaurantFirstName] =
    useState("");
  const [registerRestaurantLastName, setRegisterRestaurantLastName] =
    useState("");
  ...
  const RenderLoginChoice = () => {
    ...
    return (
      <View key={"loginChoice"} style={styles.mainScreenContainer}>
  ...
  const RenderPhoneLogin = () => {
    ...
    const handlePhoneValidation = async () => {
      ...
      const loginCredentials = await handleUserThereAPIRequest({
        input: phoneNumber,
        datatype: type,
      });
    ...
    const handleActivation = async () => {
      try {
        const response = await checkActivation(
          activationDevice.type,
          activationDevice.input,
          verificationCode
        );
    ...
    return (
      <TouchableWithoutFeedback onPress={dismissKeyboard}>
        <View key={"usernameChoice"} style={styles.container}>
          ...
          <TouchableOpacity
            style={styles.smallbutton}
            onPress={() => handleLogin(chosenusername)}
          >
            <Text style={styles.buttonText}>Los gehts</Text>
          </TouchableOpacity>
        </View>
    ...
    return (
      <TouchableWithoutFeedback onPress={dismissKeyboard}>
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={handleHowFoodupWorks}>
            <Text style={styles.info}>Wie funktioniert foodup?</Text>
          </TouchableOpacity>
        </View>
      </TouchableWithoutFeedback>
    );
    ...
    return (
      <TouchableWithoutFeedback onPress={dismissKeyboard}>
        <View style={styles.container}>
          ...
          <Text style={[styles.info, { paddingBottom: 20, width: "70%" }]}>
            {tagsInfo}
          </Text>
    ...
    return (
      <TouchableWithoutFeedback onPress={dismissKeyboard}>
        <View style={styles.container}>
          ...
          <Text style={styles.info}>
            Wir melden uns bei Dir nachdem wir Deine Anfrage geprüft haben
          </Text>
          <TouchableOpacity
            style={styles.smallbutton}
  ...
  return (
    <View style={{ flex: 1 }}>
      <Stack.Navigator>
        <Stack.Screen
          name="LoginChoice"
          component={RenderLoginChoice}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="PhoneLogin"
          component={RenderPhoneLogin}
          options={{
        ...
        <Stack.Screen
          ...
          component={RenderActivationCode}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        ...
        />
        <Stack.Screen
          name="RestaurantRegisterName"
          component={RenderRestaurantRegisterName}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          name="RestaurantRegisterTags"
          component={RenderRestaurantRegisterTags}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          name="RestaurantRegisterAdress"
          component={RenderRestaurantRegisterAdress}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          name="HowFoodupWorks"
          component={RenderHowFoodUpWorks}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          name="RestaurantRegisterPhoneAndEmail"
          component={RenderRestaurantRegisterPhoneAndEmail}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          name="RestaurantRegisterUser"
          component={RenderRestaurantRegisterUser}
          options={{
            header: () => <CustomHeader arrowShown={true} logoShown={false} />,
          }}
        />
        <Stack.Screen
          ...
          component={RenderRestaurantRegistered}
          options={{
